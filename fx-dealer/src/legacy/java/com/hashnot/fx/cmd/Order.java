...
public class Order {
    ...
    public static void main(String[] args) throws Exception {
        Collection<IExchangeMonitor> exchanges = Main.loadExchanges(args[0], Executors.newScheduledThreadPool(10));
    ...
    private static BigDecimal order(IExchangeMonitor x, OrderType type, BigDecimal amount, BigDecimal value, CurrencyPair pair) throws ExecutionException, InterruptedException {
        ...
        new OrderTracker(x.getUserTradesMonitor()).addTradeListener(dealer);
